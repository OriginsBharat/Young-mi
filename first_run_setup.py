# first_run_setup.py
# This script is the streamlined, zero-effort setup wizard for the user.
...
def install_dependencies():
    ...
    try:
        ...
        print("This may have happened because a system-level dependency is missing.")
        print("Please ensure you have installed Tesseract-OCR, PortAudio, and Python3-Dev.")
        return False
...
def create_env_file():
    ...
    print("\nFor voice cloning, provide a clear audio sample (5-15 seconds is ideal). If you leave this blank, a default voice will be used.")
    voice_clone_path = input("Enter the full path to your voice sample .wav file (optional): ").strip()
...
def run_setup():
    ...
    print("This wizard will install dependencies and configure the application.")
